...
fn context_snapshot() -> ContextEditorSnapshot {
    ContextEditorSnapshot {
        ...
        messages: vec![ContextEditorMessage {
            ...
            summary_coverage: Some(ContextSummaryCoverage {
                ...
                tasks: vec![ContextCuratorTaskPreview {
                    ...
                    file_evidence: Some(jcode_session_types::StoredContextFileEvidence {
                        ...
                        searched_or_browsed: jcode_session_types::StoredContextPathEvidence {
                            ...
                            complete: false,
                            warnings: vec!["opaque shell search may be incomplete".to_string()],
                        },
                    }),
                    user_instructions: ContextCuratorInstructionDisclosure {
                        transaction_wide_chars: 12,
                        task_specific_chars: 7,
                    },
                }],
