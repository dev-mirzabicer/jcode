...
impl Request {
    pub fn id(&self) -> u64 {
        match self {
            ...
            Request::PreviewStartupContextSelection { id, .. } => *id,
            Request::ApplyStartupContextSelection { id, .. } => *id,
            Request::CancelStartupContextApply { id, .. } => *id,
            Request::GetStartupContextApplyStatus { id, .. } => *id,
            ...
            Request::PreviewContextDraftSelection { id, .. } => *id,
            Request::ApplyContextDraft { id, .. } => *id,
            Request::ListContextTransactions { id, .. } => *id,
            Request::GetContextTransactionDetail { id, .. } => *id,
