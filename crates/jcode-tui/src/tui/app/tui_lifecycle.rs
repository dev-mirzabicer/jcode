...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            context_pressure_session_id: None,
            context_action_request_id: None,
            ...
            startup_context_ui: super::startup_context_ui::StartupContextUiState::default(),
            instruction_ui: super::instruction_ui::InstructionUi::default(),
            task_ui: super::task_ui::TaskUi::default(),
            ...
            pending_agent_catalog_replace: false,
            ...
            pending_composer_input: None,
            blocked_composer_restore_pending: false,
