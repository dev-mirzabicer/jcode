        ...
        let mut payload = serde_json::json!({
            ...
            "ui": {
                ...
                "remote_state": {
                    ...
                    "startup_context_supported": self.startup_context_compact_status().is_some(),
                    "startup_context_state": self.startup_context_compact_status().map(|status| format!("{:?}", status.state)),
                    "startup_context_plan_entries": self.startup_context_compact_status().map(|status| status.plan_entry_count),
                    "startup_context_receipt_files": self.startup_context_compact_status().map(|status| status.receipt_file_count),
                },
                "skills": {
