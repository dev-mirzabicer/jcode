        ...
        let mut payload = serde_json::json!({
            ...
            "ui": {
                ...
                "remote_state": {
                    ...
                    "startup_context_supported": self.remote_startup_context.is_some(),
                    "startup_context_state": self.remote_startup_context.as_ref().map(|status| format!("{:?}", status.state)),
                    "startup_context_plan_entries": self.remote_startup_context.as_ref().map(|status| status.plan_entry_count),
                    "startup_context_receipt_files": self.remote_startup_context.as_ref().map(|status| status.receipt_file_count),
                },
                "skills": {
