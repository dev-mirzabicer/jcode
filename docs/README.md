...
- Agent profiles and prompt freezing: `AGENT_PROFILES.md`, `SYSTEM_PROMPT_CONFIG.md`; managed Git stores: `INSTRUCTION_STORES.md`; read-only manager: `INSTRUCTION_MANAGER.md`; skills: `SKILLS.md`; launch-time model policy: `MODEL_ROSTER.md`
